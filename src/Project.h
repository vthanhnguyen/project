...
public:
	...
	void dailyReport();
	// Displays a complete report when the user exits the program

	void options(); // Allows the user to set flags on whether or not they would like to drop the lowest quiz, hw, or exam.
